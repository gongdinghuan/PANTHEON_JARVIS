...
class MemoryConsolidationSystem:
    ...
    def update_knowledge_graph(self, learning_content):
        ...
        print(f"✅ 知识图谱已更新: {graph_file}")
        print(f"   节点数: {knowledge_graph['metadata']['total_nodes']}")
        print(f"   边数: {knowledge_graph['metadata']['total_edges']}")
...
<body class="p-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-sm text-gray-500 mt-2">生成时间: {self.now.strftime("%Y-%m-%d %H:%M:%S")}</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            <div class="glass-card p-6 text-center">
                ...
                <div class="text-gray-400">学习会话</div>
            </div>
            <div class="glass-card p-6 text-center">
            ...
            <div class="glass-card p-6 text-center">
                ...
                <div class="text-gray-400">关系连接</div>
            </div>
            <div class="glass-card p-6 text-center">
                <div class="text-4xl font-bold text-yellow-400 mb-2">{len(learning_content['key_insights'])}</div>
                <div class="text-gray-400">核心洞察</div>
            </div>
        </div>
        
        <!-- Learning Sessions -->
        <div class="glass-card p-8 mb-8">
            <h2 class="text-3xl font-bold mb-6 text-purple-400">📚 今日学习会话</h2>
            ...
            <div class="mb-8 p-6 rounded-lg bg-gradient-to-r from-purple-900/30 to-cyan-900/30 border border-purple-500/30">
                ...
                <p class="text-gray-400 mb-4">⏱️ 时长: {session['duration']}</p>
        ...
        <div class="glass-card p-8 mb-8">
            <h2 class="text-3xl font-bold mb-6 text-cyan-400">🕸️ 知识图谱结构</h2>
            
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                {"".join([f"""
                <div class="node-card p-4 rounded-lg">
                    <h4 class="font-semibold text-purple-300 mb-2">🔹 {node['label']}</h4>
                    <p class="text-sm text-gray-400 mb-2">类型: {node['type']}</p>
                    <p class="text-sm text-gray-400">掌握度: {node['mastery']}%</p>
                </div>
        ...
        <!-- Key Insights -->
        <div class="glass-card p-8 mb-8">
            <h2 class="text-3xl font-bold mb-6 text-green-400">💡 核心洞察</h2>
        ...
        <!-- Learning Path -->
        <div class="glass-card p-8 mb-8">
            <h2 class="text-3xl font-bold mb-6 text-yellow-400">🎯 学习路径</h2>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-start p-4 rounded-lg bg-black/30">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-400 mb-2">⏱️ {stage['duration']}</p>
        ...
        <!-- Next Steps -->
        <div class="glass-card p-8 mb-8">
            <h2 class="text-3xl font-bold mb-6 text-red-400">🚀 下一步行动</h2>
            
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                {"".join([f"""
                <div class="p-4 rounded-lg bg-gradient-to-r from-red-900/30 to-orange-900/30 border border-red-500/30">
        ...
        <div class="glass-card p-8">
            <h2 class="text-3xl font-bold mb-6 text-pink-400">🔗 知识关联</h2>
    ...
    def run_consolidation(self):
        ...
        try:
            ...
            print("📊 固化统计:")
            print(f"   - 学习会话: {len(learning_content['learning_sessions'])}")
            print(f"   - 知识节点: {knowledge_graph['metadata']['total_nodes']}")
            print(f"   - 关系连接: {knowledge_graph['metadata']['total_edges']}")
            print(f"   - 核心洞察: {len(learning_content['key_insights'])}")
            print(f"   - 学习阶段: {len(learning_path['learning_stages'])}")
            print()
            
            return report_path
            
        except Exception as e:
            print(f"❌ 固化过程出错: {str(e)}")
            return None
